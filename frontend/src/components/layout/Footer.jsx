        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Nền tảng mua sắm thông minh với AI, mang đến trải nghiệm mua sắm tốt nhất cho bạn.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/warranty" className="hover:text-white">Bảo hành</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>Email: support@ai-ecommerce.vn</li>
