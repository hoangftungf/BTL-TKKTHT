    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('cod', 'Thanh toán khi nhận hàng'), ('momo', 'Ví MoMo'), ('vnpay', 'VNPay'), ('bank_transfer', 'Chuyển khoản')], max_length=20, verbose_name='Phương thức thanh toán')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_history', to='order_app.order')),
            ],
            options={
