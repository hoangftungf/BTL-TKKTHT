...
Usage:
    ...
    python manage.py consume_events --queue rec_events
...
EVENT_ROUTING = {
    'product.updated': 'recommendation_app.event_handlers.handle_product_updated',
    'product.deleted': 'recommendation_app.event_handlers.handle_product_deleted',
    'order.placed': 'recommendation_app.event_handlers.handle_order_placed',
    'review.created': 'recommendation_app.event_handlers.handle_review_created',
}
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--queue',
            default='ai_recommendation_events',
            help='RabbitMQ queue name (default: ai_recommendation_events)',
        )
        parser.add_argument(
            '--once',
            action='store_true',
